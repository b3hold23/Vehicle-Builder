...
class Cli extends Vehicle implements AbleToTow{
    ...
    inquirer
      ...
      .then((answers) => {
        if (answers.vehicleType === 'Car') {
          // create a car
          this.createCar();
          // Statements for creating a truck and a motorbike
  ...
  findVehicleToTow(truck: Truck): void {
    inquirer
      ...
      .then((answers) => {
        console.log("Selected VIN for towing:", answers.vehicleToTow); // Debugging output
        ...
        console.log("Vehicle to tow found:", vehicleToTow); // Debugging output
